...
class TestJob
{
    ...
    {
        // $int = new InventoryController();
        // ... Set up environment for this job
        // parent::__construct();
        // echo '<pre> Test 1 :: Starts';
        // print_r(PDO::class);
        // // print_r($this->db);
        // // print_r(get_class_methods(\get_class($int)));
        // echo '</pre>';
        // die('LOOP ENDS HERE');
    }
    ...
    public function perform()
    {
        ...
        // $logger->info(json_encode('test teju'));
        //$is_result = $this->insertOrUpdateInventory($map_data, $this->args['UserId'], $this->db);
    }
