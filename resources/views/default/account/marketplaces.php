<?php
$title_meta = 'Marketplaces at Tracksz, a Multiple Market Inventory Management Service';
$description_meta = 'Marketplaces at Tracksz, a Multiple Market Inventory Management Service. Manage all aspects of your store.';
?>
        ...
        <div class="page-inner">
            <header class="page-title-bar">
                ...
                <div class="mb-3 d-flex justify-content-between">
                    <h1 class="page-title"> <?=_('Your Marketplaces')?> </h1>
                </div>
