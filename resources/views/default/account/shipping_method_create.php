                                ...
                                <div class="content">
                                    <fieldset>
                                        ...
                                        <div class="form-row mb-2">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="DeliveryTime" class="required-field"><?=_('Delivery Time')?></label> <input type="text" title="<?=_('Enter the delivery time this method applies to.')?>" class="form-control" id="DeliveryTime" name="DeliveryTime" placeholder="<?=_('Ex. 21-36 Business Days')?>" maxlength="75" required data-parsley-required-message="<?=_('Enter the delivery time this method applies to.')?>" value="<?php echo isset($updateDelivery) ? $updateDelivery : '';?>">
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <button type="submit" class="next btn btn-primary ml-auto"><?=_(isset($updateId) ? 'Update Method' : 'Create Method')?></button>
                                        </div>
                                    </fieldset>
                                </div>
                            </form>
