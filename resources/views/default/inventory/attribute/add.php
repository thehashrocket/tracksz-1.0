                ...
                <div class="card-deck-xl">
                    ...
                    <div class="card card-fluid">
                        ...
                        <div class="card-body">
                            ...
                            <form name="attribute_market_request" id="attribute_market_request" action="/attribute/insert_attribute" method="POST" enctype="multipart/form-data" data-parsley-validate>
                                <div class="container">
                                    <div class="row">
                                        <div class="col-sm">
                                            <div class="form-group">
                                                <label for="AttributeName">Attribute Name</label>
                                                <input type="text" class="form-control" id="AttributeName" name="AttributeName" placeholder="Enter Attribute Name" data-parsley-required-message="<?= _('Enter Attribute Name') ?>" data-parsley-group="fieldset01" required value="<?php echo (isset($form['AttributeName']) && !empty($form['AttributeName'])) ? $form['AttributeName'] : ''; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="AttributeValue">Attribute Value</label>
                                                <input type="text" class="form-control" id="AttributeValue" name="AttributeValue" placeholder="Enter Attribute Value" data-parsley-required-message="<?= _('Enter Attribute Value') ?>" data-parsley-group="fieldset01" required value="<?php echo (isset($form['AttributeValue']) && !empty($form['AttributeValue'])) ? $form['AttributeValue'] : ''; ?>">
                                            </div>
