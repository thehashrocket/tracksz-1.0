                                    ...
                                    <div class="row">
                                        <div class="col-sm">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="CategoryName" name="CategoryName" placeholder="Enter Category Name" data-parsley-required-message="<?=_('Enter Category Name')?>" data-parsley-group="fieldset01" required
                                                value="<?php echo (isset($form['CategoryName']) && !empty($form['CategoryName'])) ? $form['CategoryName'] : ''; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="CategoryDescription">Category Description</label>
                                                <textarea class="form-control" id="CategoryDescription" name="CategoryDescription"
                                                    rows="3" data-parsley-required-message="<?=_('Enter Category Description')?>" placeholder="Enter Category Description" data-parsley-group="fieldset01" required><?php echo (isset($form['CategoryDescription']) && !empty($form['CategoryDescription'])) ? $form['CategoryDescription'] : ''; ?></textarea>
                                            </div>
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                if (isset($all_category) && !empty($all_category)) {
                                                    ...
                                                    <option value="<?php echo $cat_val['Id']; ?>" <?php echo (isset($form['ParentCategory']) && $form['ParentCategory'] == $cat_val['Id']) ? 'selected' : ''; ?>><?php echo $cat_val['Name']; ?></option>
                                                <?php }} else {?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" id="CategoryImage" name="CategoryImage" multiple=""> <label class="custom-file-label" for="CategoryImage" data-parsley-required-message="<?=_('Select Inventory File Upload')?>" data-parsley-group="fieldset01" required><?=_('Choose file')?></label>
                                                </div>
                                            </div>
