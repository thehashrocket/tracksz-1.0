...
<div class="page-section"> <!-- .page-section starts -->
    <div class="card-deck-xl"> <!-- .card-deck-xl starts -->                
            ...
            <div class="card-body">  <!-- .card-body starts --> 
                ...
                <form name="category_market_request" id="category_market_request" action="/category/update"
                        ...
                        <div class="row">
                            <div class="col-sm">
                                <div class="form-group">
                                    ...
                                    value="<?php echo (isset($form['CategoryName']) && !empty($form['CategoryName'])) ? $form['CategoryName'] : $form['Name']; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="CategoryDescription" name="CategoryDescription"
                                        rows="3" data-parsley-required-message="<?=_('Enter Category Description')?>" placeholder="Enter Category Description" data-parsley-group="fieldset01" required><?php echo (isset($form['CategoryDescription']) && !empty($form['CategoryDescription'])) ? $form['CategoryDescription'] : $form['Description']; ?></textarea>
                                </div>
