<?php
$title_meta = 'Customer Group Edit for Your Tracksz Store, a Multiple Market Product Management Service';
$description_meta = 'Customer Group Edit for your Tracksz Store, a Multiple Market Product Management Service';
?>
    ...
    <div class="page">
        ...
        <div class="page-inner">
            ...
            <header class="page-title-bar">
                <div class="d-flex flex-column flex-md-row">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="/customergroup/page" title="Customer Group"><?= ('Customer Groups') ?></a>
                            </li>
                ...
                <!-- title -->
                <h1 class="page-title"> <?= _('Customer Group Edit') ?> </h1>
                <p class="text-muted">
                ...
                <div class="card-deck-xl">
                    ...
                    <div class="card card-fluid">
                        ...
                        <div class="card-body">
                            ...
                            <form name="customergroup_market_request" id="customergroup_market_request" action="/customergroup/update" method="POST" data-parsley-validate>
                                <div class="container">
                                    <div class="row">
                                        <div class="col-sm">
                                            <div class="form-group">
                                                <label for="CustomerGroupName">Name</label>
                                                <input type="text" class="form-control" id="CustomerGroupName" name="CustomerGroupName" placeholder="Enter Customer Group Name" data-parsley-required-message="<?= _('Enter Customer Group Name') ?>" data-parsley-group="fieldset01" required value="<?php echo (isset($form['CustomerGroupName']) && !empty($form['CustomerGroupName'])) ? $form['CustomerGroupName'] : $form['Name']; ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="CustomerGroupDescription" name="CustomerGroupDescription" rows="3"><?php echo (isset($form['CustomerGroupDescription']) && !empty($form['CustomerGroupDescription'])) ? $form['CustomerGroupDescription'] : $form['Description']; ?></textarea>
                                            </div>

                                            <div class="form-group">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="CustomerGroupApproval" id="CustomerGroupApproval" data-parsley-required-message="<?= _('Customer Group Approval') ?>" data-parsley-group="fieldset01" value="<?php echo (isset($form['CustomerGroupApproval']) && $form['CustomerGroupApproval'] == 1) ? 1 : (isset($form['Approval']) && $form['Approval'] == 1) ? 1 : 0; ?>" <?php echo (isset($form['CustomerGroupApproval']) && $form['CustomerGroupApproval'] == 1) ? 'checked' : (isset($form['Approval']) && $form['Approval'] == 1) ? 'checked' : ''; ?>>
