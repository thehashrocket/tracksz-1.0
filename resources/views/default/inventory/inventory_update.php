    ...
    <div class="page">
        ...
        <div class="page-inner">
            ...
            <header class="page-title-bar">
                ...
                <p class="text-muted"> <?=_('This is where update inventory for the current Active Store: ')?><strong> <?=urldecode(\Delight\Cookie\Cookie::get('tracksz_active_name'))?></strong></p>
