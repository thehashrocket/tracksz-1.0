<?php
$title_meta = 'Product Discount Edit for Your Tracksz Store, a Multiple Market Product Management Service';
$description_meta = 'Product Discount Edit for your Tracksz Store, a Multiple Market Product Management Service';
?>
    ...
    <div class="page">
        ...
        <div class="page-inner">
            ...
            <header class="page-title-bar">
                ...
                <!-- title -->
                <h1 class="page-title"> <?= _('Product Discount Edit') ?> </h1>
                <p class="text-muted">
                ...
                <div class="card-deck-xl">
                    ...
                    <div class="card card-fluid">
                        ...
                        <div class="card-body">
                            ...
                            <form name="product_discount_request" id="product_discount_request" action="/productdiscount/update" method="POST" data-parsley-validate>
                                <div class="container">
                                    <div class="row">
                                        <div class="col-sm">
                                                            ...
                                                            <div class="page-section">
                                                                ...
                                                                <div class="card-deck-xl">
                                                                    ...
                                                                    <div class="card card-fluid">
                                                                        ...
                                                                        <div class="card-body">
                                                                            <!-- .card-body starts -->
                                                                            <option value=" <?php echo $prod_val['Id']; ?>" <?php echo (isset($form['DiscountProductId']) && $form['DiscountProductId'] == $prod_val['Id']) ? 'selected' : (isset($form['ProductId']) && $form['ProductId'] == $prod_val['Id']) ? 'selected' : ''; ?>><?php echo strtoupper($prod_val['Name']); ?></option>
                                                                        <?php }
                                                                } else { ?>
                                                            ...
                                                            <div class="page-section">
                                                                ...
                                                                <div class="card-deck-xl">
                                                                    ...
                                                                    <div class="card card-fluid">
                                                                        ...
                                                                        <div class="card-body">
                                                                            <!-- .card-body starts -->
                                                                            <option value=" <?php echo $cust_val['Id']; ?>" <?php echo (isset($form['DiscountCustomerGroup']) && $form['DiscountCustomerGroup'] == $cust_val['Id']) ? 'selected' : (isset($form['CustomerGroupId']) && $form['CustomerGroupId'] == $cust_val['Id']) ? 'selected' : ''; ?>><?php echo strtoupper($cust_val['Name']); ?></option>
                                                                        <?php }
                                                                } else { ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="DiscountQuantity" name="DiscountQuantity" placeholder="Enter Discount Quantity" data-parsley-required-message="<?= _('Enter Discount Quantity') ?>" data-parsley-group="fieldset01" value="<?php echo (isset($form['DiscountQuantity']) && !empty($form['DiscountQuantity'])) ? $form['DiscountQuantity'] : $form['Quantity']; ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="DiscountPriority"><?= _('Priority') ?></label>
                                                <input type="number" class="form-control" id="DiscountPriority" name="DiscountPriority" placeholder="Enter Discount Priority" data-parsley-required-message="<?= _('Enter Discount Priority') ?>" data-parsley-group="fieldset01" required min="0" value="<?php echo (isset($form['DiscountPriority']) && !empty($form['DiscountPriority'])) ? $form['DiscountPriority'] : $form['Priority']; ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="DiscountPrice"><?= _('Price') ?></label>
                                                <input type="number" class="form-control" id="DiscountPrice" name="DiscountPrice" placeholder="Enter Discount Price" data-parsley-required-message="<?= _('Enter Discount Price') ?>" data-parsley-group="fieldset01" required value="<?php echo (isset($form['DiscountPrice']) && !empty($form['DiscountPrice'])) ? $form['DiscountPrice'] : $form['Price']; ?>">
                                            </div>

                                            <div class="form-group">
                                                <label class="control-label" for="DiscountStartDate"><?= _('Start Date') ?></label> <input id="DiscountStartDate" name="DiscountStartDate" type="text" class="form-control flatpickr-input active" data-toggle="flatpickr" data-enable-time="true" data-date-format="d-m-Y H:i" readonly="readonly" value="<?php echo (isset($form['DiscountStartDate']) && !empty($form['DiscountStartDate'])) ? $form['DiscountStartDate'] : date("d-m-Y H:m:s", strtotime($form['DateStart'])); ?>">
                                            </div>

                                            <div class="form-group">
                                                <label class="control-label" for="DiscountEndDate"><?= _('End Date') ?></label> <input id="DiscountEndDate" name="DiscountEndDate" type="text" class="form-control flatpickr-input active" data-toggle="flatpickr" data-enable-time="true" data-date-format="d-m-Y H:i" readonly="readonly" value="<?php echo (isset($form['DiscountEndDate']) && !empty($form['DiscountEndDate'])) ? $form['DiscountEndDate'] : date("d-m-Y H:m:s", strtotime($form['DateEnd'])); ?>">
                                            </div>
