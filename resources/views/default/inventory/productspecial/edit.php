<?php
$title_meta = 'Product Special Edit for Your Tracksz Store, a Multiple Market Product Management Service';
$description_meta = 'Product Special Edit for your Tracksz Store, a Multiple Market Product Management Service';
?>
    ...
    <div class="page">
        ...
        <div class="page-inner">
            ...
            <header class="page-title-bar">
                ...
                <!-- title -->
                <h1 class="page-title"> <?= _('Product Special Edit') ?> </h1>
                <p class="text-muted">
                ...
                <div class="card-deck-xl">
                    ...
                    <div class="card card-fluid">
                        ...
                        <div class="card-body">
                            ...
                            <form name="product_special_request" id="product_special_request" action="/productspecial/update" method="POST" data-parsley-validate>
                                <div class="container">
                                    <div class="row">
                                        <div class="col-sm">
                                                            ...
                                                            <div class="page-section">
                                                                ...
                                                                <div class="card-deck-xl">
                                                                    ...
                                                                    <div class="card card-fluid">
                                                                        ...
                                                                        <div class="card-body">
                                                                            <!-- .card-body starts -->
                                                                            <option value=" <?php echo $prod_val['Id']; ?>" <?php echo (isset($form['SpecialProductId']) && $form['SpecialProductId'] == $prod_val['Id']) ? 'selected' : (isset($form['ProductId']) && $form['ProductId'] == $prod_val['Id']) ? 'selected' : ''; ?>><?php echo strtoupper($prod_val['Name']); ?></option>
                                                                        <?php }
                                                                } else { ?>
                                                            ...
                                                            <div class="page-section">
                                                                ...
                                                                <div class="card-deck-xl">
                                                                    ...
                                                                    <div class="card card-fluid">
                                                                        ...
                                                                        <div class="card-body">
                                                                            <!-- .card-body starts -->
                                                                            <option value=" <?php echo $cust_val['Id']; ?>" <?php echo (isset($form['SpecialCustomerGroup']) && $form['SpecialCustomerGroup'] == $cust_val['Id']) ? 'selected' : (isset($form['CustomerGroupId']) && $form['CustomerGroupId'] == $cust_val['Id']) ? 'selected' : ''; ?>><?php echo strtoupper($cust_val['Name']); ?></option>
                                                                        <?php }
                                                                } else { ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="SpecialPriority" name="SpecialPriority" placeholder="Enter Special Priority" data-parsley-required-message="<?= _('Enter Special Priority') ?>" data-parsley-group="fieldset01" required min="0" value="<?php echo (isset($form['SpecialPriority']) && !empty($form['SpecialPriority'])) ? $form['SpecialPriority'] : $form['Priority']; ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="SpecialPrice"><?= _('Price') ?></label>
                                                <input type="number" class="form-control" id="SpecialPrice" name="SpecialPrice" placeholder="Enter Special Price" data-parsley-required-message="<?= _('Enter Special Price') ?>" data-parsley-group="fieldset01" required value="<?php echo (isset($form['SpecialPrice']) && !empty($form['SpecialPrice'])) ? $form['SpecialPrice'] : $form['Price']; ?>">
                                            </div>

                                            <div class="form-group">
                                                <label class="control-label" for="SpecialStartDate"><?= _('Start Date') ?></label> <input id="SpecialStartDate" name="SpecialStartDate" type="text" class="form-control flatpickr-input active" data-toggle="flatpickr" data-enable-time="true" data-date-format="d-m-Y H:i" readonly="readonly" value="<?php echo (isset($form['SpecialStartDate']) && !empty($form['SpecialStartDate'])) ? $form['SpecialStartDate'] : date("d-m-Y H:m:s", strtotime($form['DateStart'])); ?>">
                                            </div>

                                            <div class="form-group">
                                                <label class="control-label" for="SpecialEndDate"><?= _('End Date') ?></label> <input id="SpecialEndDate" name="SpecialEndDate" type="text" class="form-control flatpickr-input active" data-toggle="flatpickr" data-enable-time="true" data-date-format="d-m-Y H:i" readonly="readonly" value="<?php echo (isset($form['SpecialEndDate']) && !empty($form['SpecialEndDate'])) ? $form['SpecialEndDate'] : date("d-m-Y H:m:s", strtotime($form['DateEnd'])); ?>">
                                            </div>
