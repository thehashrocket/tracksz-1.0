<?php
$title_meta = 'Recurring Edit for Your Tracksz Store, a Multiple Market Product Management Service';
$description_meta = 'Recurring Edit for your Tracksz Store, a Multiple Market Product Management Service';
?>
    ...
    <div class="page">
        ...
        <div class="page-inner">
            ...
            <header class="page-title-bar">
                ...
                <!-- title -->
                <h1 class="page-title"> <?= _('Recurring Edit') ?> </h1>
                <p class="text-muted">
                ...
                <div class="card-deck-xl">
                    ...
                    <div class="card card-fluid">
                        ...
                        <div class="card-body">
                            ...
                            <form name="recurring_market_request" id="recurring_market_request" action="/recurring/update" method="POST" enctype="multipart/form-data" data-parsley-validate>
                                <div class="container">
                                    <div class="row">
                                        <div class="col-sm">
                                            <div class="form-group">
                                                <label for="RecurringName">Recurring Name</label>
                                                <input type="text" class="form-control" id="RecurringName" name="RecurringName" placeholder="Enter Recurring Name" data-parsley-required-message="<?= _('Enter Recurring Name') ?>" data-parsley-group="fieldset01" required value="<?php echo (isset($form['RecurringName']) && !empty($form['RecurringName'])) ? $form['RecurringName'] : $form['Name']; ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="RecurringPrice" name="RecurringPrice" placeholder="Enter Recurring Name" data-parsley-required-message="<?= _('Enter Recurring Price') ?>" data-parsley-group="fieldset01" required value="<?php echo (isset($form['RecurringPrice']) && !empty($form['RecurringPrice'])) ? $form['RecurringPrice'] : $form['Price']; ?>">
                                            </div>
                                                            ...
                                                            <div class="page-section">
                                                                ...
                                                                <div class="card-deck-xl">
                                                                    ...
                                                                    <div class="card card-fluid">
                                                                        ...
                                                                        <div class="card-body">
                                                                            <!-- .card-body starts -->
                                                                            <option value="<?php echo $rec_val['name']; ?>" <?php echo (isset($form['RecurringFrequency']) && $form['RecurringFrequency'] == $rec_val['name']) ? 'selected' : (isset($form['Frequency']) && $form['Frequency'] == $rec_val['name']) ? 'selected' : ''; ?>><?php echo strtoupper($rec_val['name']); ?></option>
                                                                        <?php }
                                                                } else { ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="RecurringDuration" name="RecurringDuration" placeholder="Enter Recurring Duration" data-parsley-required-message="<?= _('Enter Recurring Duration') ?>" data-parsley-group="fieldset01" required value="<?php echo (isset($form['RecurringDuration']) && !empty($form['RecurringDuration'])) ? $form['RecurringDuration'] : $form['Duration']; ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="RecurringCycle">Cycle</label>
                                                <input type="number" class="form-control" id="RecurringCycle" name="RecurringCycle" placeholder="Enter Recurring Cycle" data-parsley-required-message="<?= _('Enter Recurring Duration') ?>" data-parsley-group="fieldset01" required value="<?php echo (isset($form['RecurringCycle']) && !empty($form['RecurringCycle'])) ? $form['RecurringCycle'] : $form['Cycle']; ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="TrailStatus"><?= _('Trail Status') ?></label>
                                                <select name="TrailStatus" id="TrailStatus" class="browser-default custom-select">
                                                    <option value="0" <?php echo (isset($form['TrailStatus']) && $form['TrailStatus'] == 0) ? 'selected' : (isset($form['TrialStatus']) && $form['TrialStatus'] == 0) ? 'selected' : ''; ?>><?= _('Disable') ?></option>
                                                    <option value="1" <?php echo (isset($form['TrailStatus']) && $form['TrailStatus'] == 1) ? 'selected' : (isset($form['TrialStatus']) && $form['TrialStatus'] == 1) ? 'selected' : ''; ?>><?= _('Enable') ?></option>
                                                </select>
                                            </div>
                                                            ...
                                                            <div class="page-section">
                                                                ...
                                                                <div class="card-deck-xl">
                                                                    ...
                                                                    <div class="card card-fluid">
                                                                        ...
                                                                        <div class="card-body">
                                                                            <!-- .card-body starts -->
                                                                            <option value="<?php echo $rec_val['name']; ?>" <?php echo (isset($form['RecurringTrailFrequency']) && $form['RecurringTrailFrequency'] == $rec_val['name']) ? 'selected' : (isset($form['TrialFrequency']) && $form['TrialFrequency'] == $rec_val['name']) ? 'selected' : ''; ?>><?php echo strtoupper($rec_val['name']); ?></option>
                                                                        <?php }
                                                                } else { ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="RecurringStatus" id="RecurringStatus" class="browser-default custom-select">
                                                    <option value="0" <?php echo (isset($form['RecurringStatus']) && $form['RecurringStatus'] == 0) ? 'selected' : (isset($form['Status']) && $form['Status'] == 0) ? 'selected' : ''; ?>><?= _('Disable') ?></option>
                                                    <option value="1" <?php echo (isset($form['RecurringStatus']) && $form['RecurringStatus'] == 1) ? 'selected' : (isset($form['Status']) && $form['Status'] == 1) ? 'selected' : ''; ?>><?= _('Enable') ?></option>
                                                </select>
                                            </div>
