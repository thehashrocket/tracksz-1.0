...
<div class="wrapper">
    ...
    <div class="page">
        ...
        <div class="page-inner">
            ...
            <!-- Steppers Ends -->
            <form name="category_market_request" id="category_market_request" action="<?=\App\Library\Config::get('company_url')?>/marketplace/add/step3" method="POST" data-parsley-validate="">
                                        ...
                                        <div class="form-group"> <!-- form-group starts -->
                                            <label for="FtpId"><?=_('FTP ID')?></label>
                                                <input type="text" class="form-control" id="FtpId" name="FtpId" placeholder="Enter Ftp Id" data-parsley-required-message="<?=_('Enter Ftp Id')?>" data-parsley-group="fieldset01" required
                                                    value="<?php echo (isset($form['FtpId']) && !empty($form['FtpId'])) ? $form['FtpId'] : ''; ?>">
                                        </div> <!-- form-group ends -->
                                        ...
                                        <div class="form-group"> <!-- form-group starts -->
                                            <label for="FtpPwd"><?=_('FTP Pwd')?></label>
                                                <input type="password" class="form-control" id="FtpPwd" name="FtpPwd" placeholder="Enter Ftp Password" data-parsley-required-message="<?=_('Enter Ftp Password')?>" data-parsley-group="fieldset01" required
                                                    value="<?php echo (isset($form['FtpPwd']) && !empty($form['FtpPwd'])) ? $form['FtpPwd'] : ''; ?>">
                                                    <small id="FtpPwdNote" class="form-text text-muted" aria-describedby="FtpPwdNote"><?=_('Note: Value will always appear as asterisks for security purposes')?></small>
                                        </div> <!-- form-group ends -->
                                    ...
                                    <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="IncreaseMinMarket" id="IncreaseMinMarket" placeholder="Enter IncreaseMinMarket" data-parsley-required-message="<?=_('Enter IncreaseMinMarket')?>" data-parsley-group="fieldset01" required
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">
                                                <div class="form-check">
                                                    ...
                                                    value="<?php echo (isset($form['SuspendExport']) && !empty($form['SuspendExport'])) ? 'checked' : ''; ?>">
                                        ...
                                        <div class="form-group">
                                                <div class="form-check">
                                                    ...
                                                    value="<?php echo (isset($form['SendDeletes']) && !empty($form['SendDeletes'])) ? 'checked' : ''; ?>">
                                    ...
                                    <div class="col-6">
                                        <label for="PrependVenue"><?=_('Marketplace accepts prices in:')?></label>
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="MarketAcceptPriceVal" id="MarketAcceptPriceVal" aria-label="Amount (to the nearest dollar)" data-parsley-required-message="<?=_('Enter Marketplace Accept Price')?>" data-parsley-group="fieldset01" required
                                                ...
                                                <input type="text" class="form-control" name="MarketAcceptPriceValMulti" id="MarketAcceptPriceValMulti" aria-label="Amount (to the nearest dollar)" data-parsley-required-message="<?=_('Enter Marketplace Accept Price')?>" data-parsley-group="fieldset01" required
                            ...
                            if (isset($market_price) && !empty($market_price)) {
                                foreach ($market_price as $mar_key => $mar_val) {?>
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="MarketAcceptPriceVal2" id="MarketAcceptPriceVal2" aria-label="Amount (to the nearest dollar)" data-parsley-required-message="<?=_('Enter Marketplace Accept Price')?>" data-parsley-group="fieldset01" required
                                                ...
                                                <input type="text" class="form-control" name="MarketAcceptPriceValMulti2" id="MarketAcceptPriceValMulti2" aria-label="Amount (to the nearest dollar)" data-parsley-required-message="<?=_('Enter Marketplace Accept Price')?>" data-parsley-group="fieldset01" required
                                     ...
                                     <a href="<?=\App\Library\Config::get('company_url')?>/marketplace/browse" class="btn btn-warning"><i class="fa fa-arrow-left"></i> <?=_('Cancel')?> </a> &nbsp;
