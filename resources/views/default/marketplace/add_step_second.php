...
?>>
                        ...
                        <div class="col-6"> 
                                        ...
                                        <div class="form-group">
                                            <label for="BasePrice">Base price in US Dollars will be sent as:</label>
                                            <input type="text" class="form-control" id="BasePrice" name="BasePrice" placeholder="Enter Prepend Venue" data-parsley-required-message="<?=_('Enter Prepend Venue')?>" data-parsley-group="fieldset01" required <?php if (isset($store['PrependVenue'])) {
                                                    echo ' value="' . $store['PrependVenue'] . '"'; } ?>>
                                        </div>
