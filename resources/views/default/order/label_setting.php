                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="SkipPDFView" id="SkipPDFView" data-parsley-required-message="<?=_('Enter SkipPDFView')?>" data-parsley-group="fieldset01" 
                                                <?php echo (isset($all_order['SkipPDFView']) && $all_order['SkipPDFView'] == 1) ? 'checked' : ''; ?>>
                                ...
                                <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="col-sm">
                                            ...
                                            <div class="form-group">
                                                 <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="SplitOrders" id="SplitOrders" data-parsley-required-message="<?=_('Enter SplitOrders')?>" data-parsley-group="fieldset01" 
                                                <?php echo (isset($all_order['SplitOrders']) && $all_order['SplitOrders'] == 1) ? 'checked' : ''; ?>>
                                             ...
                                             <div class="form-group">
                                                  <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="AddBarcode" id="AddBarcode" data-parsley-required-message="<?=_('Enter AddBarcode')?>" data-parsley-group="fieldset01" 
                                                <?php echo (isset($all_order['AddBarcode']) && $all_order['AddBarcode'] == 1) ? 'checked' : ''; ?>>
                                    ...
                                    <div class="row">
                                         <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="IncludeOrderBarcodes" id="IncludeOrderBarcodes" data-parsley-required-message="<?=_('Enter IncludeOrderBarcodes')?>" data-parsley-group="fieldset01" 
                                                <?php echo (isset($all_order['IncludeOrderBarcodes']) && $all_order['IncludeOrderBarcodes'] == 1) ? 'checked' : ''; ?>>
                                ...
                                <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            ...
                                            <div class="form-group">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="HideLabelBoundaries" id="HideLabelBoundaries" data-parsley-required-message="<?=_('Enter HideLabelBoundaries')?>" data-parsley-group="fieldset01" 
                                                <?php echo (isset($all_order['HideLabelBoundaries']) && $all_order['HideLabelBoundaries'] == 1) ? 'checked' : ''; ?>>
                                            ...
                                            <div class="form-group">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="IncludeGSTExAus2" id="IncludeGSTExAus2" data-parsley-required-message="<?=_('Enter IncludeGSTExAus2')?>" data-parsley-group="fieldset01" 
                                                <?php echo (isset($all_order['IncludeGSTExAus2']) && $all_order['IncludeGSTExAus2'] == 1) ? 'checked' : ''; ?>>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                  ...
                                                  <input type="text" class="form-control"  id="LabelHeight" name="LabelHeight" data-parsley-group="fieldset01" required value="<?php echo (isset($all_order['LabelHeight']) && !empty($all_order['LabelHeight'])) ? $all_order['LabelHeight'] : ''; ?>" style="width: 255px;">
                                                 <div class="input-group-prepend">
                                                       <select name="LabelHeightIn" id="LabelHeightIn" class="browser-default custom-select order_carrier_select">
                                                         <option value="cm" <?php if($all_order['LabelHeightIn'] == 'cm') { echo 'selected'; } ?>><?= _('cm') ?></option>
                                                        <option value="in" <?php if($all_order['LabelHeightIn'] == 'in') { echo 'selected'; } ?>><?= _('in') ?></option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
