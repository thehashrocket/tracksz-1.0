            ...
            <form>
                    <div class="container">
                        <div class="row">
                                <div class="col-sm">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="ProductNameInput" aria-describedby="nameHelp" placeholder="Enter Product Name">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="ProductSKUInput" aria-describedby="skuHelp" placeholder="Enter Product SKU">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="ProductIdInput" aria-describedby="idHelp" placeholder="Enter Product ID">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="ProductBasePriceInput" aria-describedby="priceHelp" placeholder="Enter Product Base Price">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                ...
                                                <select class="custom-select" id="inputGroupSelectCondition">
                                        ...
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">
                                                    <input type="checkbox" id="activeProd" aria-label="Checkbox for following text input"> &nbsp;&nbsp;
                                        ...
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">
                                                    <input type="checkbox" id="internationalShip" aria-label="Checkbox for following text input"> &nbsp;&nbsp;
                                        ...
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">
                                                    <input type="checkbox" id="expectedShip" aria-label="Checkbox for following text input"> &nbsp;&nbsp;
                                ...
                                <div class="col-sm">
                                     <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="titleeBayInput" aria-describedby="ebayHelp" placeholder="Enter eBay Title">
                                     ...
                                     <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="ProductQtyInput" aria-describedby="qtyHelp" placeholder="Enter Product Qty">
                                     ...
                                     <div class="input-group mb-3">
                                            ...
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="prodImage" aria-describedby="inputGroupFileAddon01">
                                                <label class="custom-file-label" for="prodImage">Choose Product Image</label>
                                            </div>
                                            </div>
                                     </div>
                                </div> <!-- col-sm -->
                        ...
                        <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="noteProduct" rows="3"></textarea>
                                </div>
                    </div> <!-- Container -->
