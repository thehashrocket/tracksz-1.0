                        ...
                        <div class="row">
                                <div class="col-sm">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="ProductNameInput" name="ProductNameInput" placeholder="Enter Product Name" data-parsley-required-message="<?=_('Enter Product Name')?>" data-parsley-group="fieldset01" required
                                            value="<?php echo (isset($form['ProductNameInput']) && !empty($form['ProductNameInput'])) ? $form['ProductNameInput'] : ''; ?>">                                            
                                        </div>
                                        <div class="form-group">
                                            <label for="ProductSKUInput"><?=_('Product SKU')?></label>
                                            <input type="text" class="form-control" id="ProductSKUInput" name="ProductSKUInput" placeholder="Enter Product SKU" data-parsley-required-message="<?=_('Enter Product SKU')?>" data-parsley-group="fieldset01" required
                                            value="<?php echo (isset($form['ProductSKUInput']) && !empty($form['ProductSKUInput'])) ? $form['ProductSKUInput'] : ''; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="ProductIdInput"><?=_('Product ID')?></label>
                                            <input type="text" class="form-control" id="ProductIdInput" name="ProductIdInput" placeholder="Enter Product ID" data-parsley-required-message="<?=_('Enter Product Id')?>" data-parsley-group="fieldset01" required
                                            value="<?php echo (isset($form['ProductIdInput']) && !empty($form['ProductIdInput'])) ? $form['ProductIdInput'] : ''; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="ProductBasePriceInput"><?=_('Base Price')?></label>
                                            <input type="number" class="form-control" id="ProductBasePriceInput" name="ProductBasePriceInput" placeholder="Enter Product Base Price"
                                            value="<?php echo (isset($form['ProductBasePriceInput']) && !empty($form['ProductBasePriceInput'])) ? $form['ProductBasePriceInput'] : ''; ?>">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="ProductActive" id="ProductActive" data-parsley-required-message="<?=_('Make Product Active')?>" data-parsley-group="fieldset01"
                                                    value="<?php echo (isset($form['ProductActive']) && $form['ProductActive'] == 1) ? 1 : 0; ?>" <?php echo (isset($form['ProductActive']) && $form['ProductActive'] == 1) ? 'checked' : ''; ?>>
                                        ...
                                        <div class="form-group">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="ProdInterShip" id="ProdInterShip" data-parsley-required-message="<?=_('International Shipping')?>" data-parsley-group="fieldset01"
                                                    value="<?php echo (isset($form['ProdInterShip']) && $form['ProdInterShip'] == 1) ? 1 : 0; ?>" <?php echo (isset($form['ProdInterShip']) && $form['ProdInterShip'] == 1) ? 'checked' : ''; ?>>
                                        ...
                                        <div class="form-group">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="ProdExpectedShip" id="ProdExpectedShip" data-parsley-required-message="<?=_('Expected Shipping')?>" data-parsley-group="fieldset01"
                                ...
                                <div class="col-sm">
                                     <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="ProdTitleBayInput" name="ProdTitleBayInput" placeholder="Enter eBay Title" data-parsley-required-message="<?=_('Enter Product SKU')?>" data-parsley-group="fieldset01" required
                                            value="<?php echo (isset($form['ProdTitleBayInput']) && !empty($form['ProdTitleBayInput'])) ? $form['ProdTitleBayInput'] : ''; ?>">
                                     </div>
                                     <div class="form-group">
                                            <label for="ProdQtyInput"><?=_('Product Qty')?></label>
                                            <input type="number" class="form-control" id="ProdQtyInput" name="ProdQtyInput" placeholder="Enter Product Qty" data-parsley-required-message="<?=_('Enter Product QTY')?>" data-parsley-group="fieldset01" required
                                            value="<?php echo (isset($form['ProdQtyInput']) && !empty($form['ProdQtyInput'])) ? $form['ProdQtyInput'] : ''; ?>">
                                     </div>
